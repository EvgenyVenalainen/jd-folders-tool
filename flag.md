This file is a **flag file**; if it is in the same folder as *Johnny.Decimal.ahk* or *Johnny.Decimal.exe*, then during operation the program will report on the progress of its work in pop-up windows.
